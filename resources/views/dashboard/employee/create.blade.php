        ...
        <form action="/dashboard/employee/create/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="row">
                    ...
                    <!-- <div class="col-6">
                        <label for="salary_id" class="form-label">Range Gaji</label>
                        <select class="custom-select form-control-border" name="salary_range" id="salary_range">
                            <option selected>Pilih Range Gaji</option>
                            <option value="day">Perhari</option>
                            <option value="month">Perbulan</option>
                            <option value="wholesale">Borongan</option>
                        </select>
                    </div> -->
                </div>
            </div>
