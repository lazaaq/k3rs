                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input" data-target="#reservationdatetime" id="time_start" name="time_start" required  value="{{$pcra->time_start}}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input" data-target="#reservationdatetime" id="time_end" name="time_end" required value="{{$pcra->time_end}}" />
                            <div class="input-group-append" data-target="#reservationdatetime" data-toggle="datetimepicker">
                                <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                            </div>
                        </div>
