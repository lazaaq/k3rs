        ...
        <div class="col-10">
            ...
            <table class="table table-hover table-stripped">
                ...
                <tr>
                    ...
                    <td><a href="/dashboard/accident/{{$accident->id}}/we/{{$witness->id}}" class="btn btn-success">Lihat</a></td>
                </tr>
                @endforeach
            </table>
            @else
        ...
        <div class="col-10">
            ...
            <table class="table table-hover table-stripped">
                ...
                <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $witness->name }}</td>
                    <td><a href="/dashboard/accident/{{$accident->id}}/wne/{{$witness->id}}" class="btn btn-success">Lihat</a></td>
                </tr>
                @endforeach
            </table>
            @else
